...
"use strict";var SwaggerClient=require("./client"),SwaggerHttp=require("./http"),SwaggerSpecConverter=module.exports=function(){this.errors=[],this.warnings=[],this.modelMap={}};SwaggerSpecConverter.prototype.setDocumentationLocation=function(e){this.docLocation=e},SwaggerSpecConverter.prototype.convert=function(e,t){if(!e||!Array.isArray(e.apis))return this.finish(t,null);var r={swagger:"2.0"};r.originalVersion=e.swaggerVersion,this.apiInfo(e,r),this.securityDefinitions(e,r),e.basePath&&this.setDocumentationLocation(e.basePath);var i,s=!1;for(i=0;i<e.apis.length;i++){var o=e.apis[i];Array.isArray(o.operations)&&(s=!0)}s?(this.declaration(e,r),this.finish(t,r)):this.resourceListing(e,r,t)},SwaggerSpecConverter.prototype.declaration=function(e,t){var r,i;if(e.apis){{e.basePath}if(0===e.basePath.indexOf("http://")){var s=e.basePath.substring("http://".length),o=s.indexOf("/");o>0?(t.host=s.substring(0,o),t.basePath=s.substring(o)):(t.host=s,t.basePath="/")}var n;if(e.authorizations&&(n=e.authorizations),e.consumes&&(t.consumes=e.consumes),e.produces&&(t.produces=e.produces),"object"==typeof e)for(r in e.models){var a=e.models[r],p=a.id||r;this.modelMap[p]=r}for(i=0;i<e.apis.length;i++){var u=e.apis[i],c=u.path,f=u.operations;this.operations(c,e.resourcePath,f,n,t)}var l=e.models;this.models(l,t)}},SwaggerSpecConverter.prototype.models=function(e,t){if("object"==typeof e){var r;t.definitions=t.definitions||{};for(r in e){var i,s=e[r],o=[],n={properties:{}};for(i in s.properties){var a=s.properties[i],p={};this.dataType(a,p),a.description&&(p.description=a.description),a["enum"]&&(p["enum"]=a["enum"]),"boolean"==typeof a.required&&a.required===!0&&o.push(i),"string"==typeof a.required&&"true"===a.required&&o.push(i),n.properties[i]=p}o.length>0&&(n["enum"]=o),t.definitions[r]=n}}},SwaggerSpecConverter.prototype.extractTag=function(e){var t=e||"default";return(0===t.indexOf("http:")||0===t.indexOf("https:"))&&(t=t.split(["/"]),t=t[t.length-1].substring()),t.replace("/","")},SwaggerSpecConverter.prototype.operations=function(e,t,r,i,s){if(Array.isArray(r)){var o;s.paths||(s.paths={});var n=s.paths[e]||{},a=this.extractTag(t);s.tags=s.tags||[];var p=!1;for(o=0;o<s.tags.length;o++){var u=s.tags[o];u.name===a&&(p=!0)}for(p||s.tags.push({name:a}),o=0;o<r.length;o++){var c=r[o],f=(c.method||c.httpMethod).toLowerCase(),l={tags:[a]},m=c.authorizations;if(m&&0===Object.keys(m).length&&(m=i),"undefined"!=typeof m)for(var h in m){l.security=l.security||[];var g=m[h];if(g){var d=[];for(var y in g)d.push(g[y].scope);var v={};v[h]=d,l.security.push(v)}else{var v={};v[h]=[],l.security.push(v)}}c.consumes?l.consumes=c.consumes:s.consumes&&(l.consumes=s.consumes),c.produces?l.produces=c.produces:s.produces&&(l.produces=s.produces),c.summary&&(l.summary=c.summary),c.notes&&(l.description=c.notes),c.nickname&&(l.operationId=c.nickname),c.deprecated&&(l.deprecated=c.deprecated),this.authorizations(m,s),this.parameters(l,c.parameters,s),this.responseMessages(l,c,s),n[f]=l}s.paths[e]=n}},SwaggerSpecConverter.prototype.responseMessages=function(e,t,r){if("object"==typeof t){var i={};this.dataType(t,i),!i.schema&&i.type&&(i={schema:i}),e.responses=e.responses||{};var s=!1;if(Array.isArray(t.responseMessages)){var o,n=t.responseMessages;for(o=0;o<n.length;o++){var a=n[o],p={description:a.message};200===a.code&&(s=!0),e.responses[""+a.code]=p}}s?e.responses["default"]=i:e.responses[200]=i}},SwaggerSpecConverter.prototype.authorizations=function(e,t){},SwaggerSpecConverter.prototype.parameters=function(e,t,r){if(Array.isArray(t)){var i;for(i=0;i<t.length;i++){var s=t[i],o={};if(o.name=s.name,o.description=s.description,o.required=s.required,o["in"]=s.paramType,"body"===o["in"]&&(o.name="body"),"form"===o["in"]&&(o["in"]="formData"),s["enum"]&&(o["enum"]=s["enum"]),s.allowMultiple===!0||"true"===s.allowMultiple){var n={};if(this.dataType(s,n),o.type="array",o.items=n,s.allowableValues){var a=s.allowableValues;"LIST"===a.valueType&&(o["enum"]=a.values)}}else this.dataType(s,o);e.parameters=e.parameters||[],e.parameters.push(o)}}},SwaggerSpecConverter.prototype.dataType=function(e,t){if("object"==typeof e){e.minimum&&(t.minimum=e.minimum),e.maximum&&(t.maximum=e.maximum),e.defaultValue&&(t["default"]=e.defaultValue);var r=this.toJsonSchema(e);r&&(t=t||{},r.type&&(t.type=r.type),r.format&&(t.format=r.format),r.$ref&&(t.schema={$ref:r.$ref}),r.items&&(t.items=r.items))}},SwaggerSpecConverter.prototype.toJsonSchema=function(e){if(!e)return"object";var t=e.type||e.dataType||e.responseClass||"",r=t.toLowerCase(),i=(e.format||"").toLowerCase();if(0===r.indexOf("list[")){var s=t.substring(5,t.length-1),o=this.toJsonSchema({type:s});return{type:"array",items:o}}if("int"===r||"integer"===r&&"int32"===i)return{type:"integer",format:"int32"};if("long"===r||"integer"===r&&"int64"===i)return{type:"integer",format:"int64"};if("integer"===r)return{type:"integer",format:"int64"};if("float"===r||"number"===r&&"float"===i)return{type:"number",format:"float"};if("double"===r||"number"===r&&"double"===i)return{type:"number",format:"double"};if("string"===r&&"date-time"===i||"date"===r)return{type:"string",format:"date-time"};if("string"===r)return{type:"string"};if("file"===r)return{type:"file"};if("boolean"===r)return{type:"boolean"};if("array"===r||"list"===r){if(e.items){var n=this.toJsonSchema(e.items);return{type:"array",items:n}}return{type:"array",items:{type:"object"}}}return e.$ref?{$ref:"#/definitions/"+this.modelMap[e.$ref]||e.$ref}:"void"===r||""===r?{}:{$ref:"#/definitions/"+this.modelMap[e.type]||e.type}},SwaggerSpecConverter.prototype.resourceListing=function(e,t,r){var i,s=0,o=this,n=e.apis.length,a=t;for(0===n&&this.finish(r,t),i=0;n>i;i++){var p=e.apis[i],u=p.path,c=this.getAbsolutePath(e.swaggerVersion,this.docLocation,u);p.description&&(t.tags=t.tags||[],t.tags.push({name:this.extractTag(p.path),description:p.description||""}));var f={url:c,headers:{accept:"application/json"},on:{},method:"get"};f.on.response=function(e){s+=1;var t=e.obj;if("undefined"==typeof t||null===t)try{t=JSON.parse(e.statusText)}catch(i){}t&&o.declaration(t,a),s===n&&o.finish(r,a)},f.on.error=function(e){console.error(e),s+=1,s===n&&o.finish(r,a)},(new SwaggerHttp).execute(f)}},SwaggerSpecConverter.prototype.getAbsolutePath=function(e,t,r){if("1.0"===e&&t.endsWith(".json")){var i=t.lastIndexOf("/");i>0&&(t=t.substring(0,i))}var s=t;return 0===r.indexOf("http://")||0===r.indexOf("https://")?s=r:(t.endsWith("/")&&(s=t.substring(0,t.length-1)),s+=r),s=s.replace("{format}","json")},SwaggerSpecConverter.prototype.securityDefinitions=function(e,t){if(e.authorizations){var r;for(r in e.authorizations){var i=!1,s={},o=e.authorizations[r];if("apiKey"===o.type)s.type="apiKey",s["in"]=o.passAs,s.name=o.keyname||r,i=!0;else if("oauth2"===o.type){var n,a=o.scopes||[],p={};for(n in a){var u=a[n];p[u.scope]=u.description}if(s.type="oauth2",n>0&&(s.scopes=p),o.grantTypes){if(o.grantTypes.implicit){var c=o.grantTypes.implicit;s.flow="implicit",s.authorizationUrl=c.loginEndpoint,i=!0}if(o.grantTypes.authorization_code&&!s.flow){var f=o.grantTypes.authorization_code;s.flow="accessCode",s.authorizationUrl=f.tokenRequestEndpoint.url,s.tokenUrl=f.tokenEndpoint.url,i=!0}}}i&&(t.securityDefinitions=t.securityDefinitions||{},t.securityDefinitions[r]=s)}}},SwaggerSpecConverter.prototype.apiInfo=function(e,t){if(e.info){var r=e.info;t.info={},r.contact&&(t.info.contact={},t.info.contact.email=r.contact),r.description&&(t.info.description=r.description),r.title&&(t.info.title=r.title),r.termsOfServiceUrl&&(t.info.termsOfService=r.termsOfServiceUrl),(r.license||r.licenseUrl)&&(t.license={},r.license&&(t.license.name=r.license),r.licenseUrl&&(t.license.url=r.licenseUrl))}else this.warnings.push("missing info section")},SwaggerSpecConverter.prototype.finish=function(e,t){e(t)};


},{"./client":3,"./http":5}],8:[function(require,module,exports){
"use strict";var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),Model=module.exports=function(e,i,t,n){return this.definition=i||{},this.isArray="array"===i.type,this.models=t||{},this.name=i.title||e||"Inline Model",this.modelPropertyMacro=n||function(e){return e["default"]},this},schemaToHTML=function(e,i,t,n){var s='<span class="strong">',r="</span>",o={},a=[],p=0,l=function(e,i,s){var r,a=i;return e.$ref?(a=e.title||helpers.simpleRef(e.$ref),r=t[a]):_.isUndefined(i)&&(a=e.title||"Inline Model "+ ++p,r=new Model(a,e,t,n)),s!==!0&&(o[a]=_.isUndefined(r)?{}:r.definition),a},m=function(e){var i='<span class="propType">',t=e.type||"object";return e.$ref?i+=l(e,helpers.simpleRef(e.$ref)):"object"===t?i+=_.isUndefined(e.properties)?"object":l(e):"array"===t?(i+="Array[",_.isArray(e.items)?i+=_.map(e.items,l).join(","):_.isPlainObject(e.items)?i+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?l(e.items):e.items.type:l(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),i+="object"),i+="]"):i+=e.type,i+="</span>"},d=function(e,i){var t="",n=e.type||"object",s="array"===n;switch(s&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e["default"])||(t+=helpers.optionHtml("Default",e["default"])),n){case"string":e.minLength&&(t+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(t+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(t+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(t+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(t+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(t+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(t+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(t+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(s&&(e.minItems&&(t+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(t+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(t+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(t+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var r;r="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',t+=helpers.optionHtml("Enum",r)}return t.length>0&&(i='<span class="propWrap">'+i+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+t+"</table></span>"),i},c=function(e,i){var o=e.type||"object",p="array"===e.type,c=s+i+" "+(p?"[":"{")+r;return i&&a.push(i),p?_.isArray(e.items)?c+="<div>"+_.map(e.items,function(e){var i=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],i)>-1?"object"===i&&_.isUndefined(e.properties)?"object":l(e):d(e,i):l(e,helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?c+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"<div>object</div>":"<div>"+l(e.items)+"</div>":"<div>"+d(e.items,e.items.type)+"</div>":"<div>"+l(e.items,helpers.simpleRef(e.items.$ref))+"</div>":(helpers.log("Array type's 'items' property is not an array or an object, cannot process"),c+="<div>object</div>"):e.$ref?c+="<div>"+l(e,i)+"</div>":"object"===o?(c+="<div>",_.isPlainObject(e.properties)&&(c+=_.map(e.properties,function(i,s){var r,o=_.cloneDeep(i),a=_.indexOf(e.required||[],s)>-1,p='<span class="propName '+a+'">'+s+"</span> (";return o["default"]=n(o),o=helpers.resolveSchema(o),_.isUndefined(o.$ref)||(r=t[helpers.simpleRef(o.$ref)],(_.isUndefined(r)||-1===_.indexOf([void 0,"array","object"],r.definition.type))&&(o=helpers.resolveSchema(r.definition))),p+=m(o),a||(p+=', <span class="propOptKey">optional</span>'),p+=")",_.isUndefined(o.description)||(p+=": "+o.description),o["enum"]&&(p+=' = <span class="propVals">[\''+o["enum"].join("' or '")+"']</span>"),d(o,p)}).join(",</div><div>")),c+="</div>"):c="<div>"+d(e,o)+"</div>",c+s+(p?"]":"}")+r};i=helpers.resolveSchema(i);for(var f=c(i,e);_.keys(o).length>0;)_.forEach(o,function(e,i){var t=_.indexOf(a,i)>-1;delete o[i],t||(a.push(i),f+="<br />"+c(e,i))});return f},schemaToJSON=function(e,i,t,n){e=helpers.resolveSchema(e);var s,r,o=e.type||"object",a=e.format;return e.example?r=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(r=e["enum"][0]),_.isUndefined(r)&&(e.$ref?(s=i[helpers.simpleRef(e.$ref)],_.isUndefined(s)||(_.isUndefined(t[s.name])?(t[s.name]=s,r=schemaToJSON(s.definition,i,t,n),delete t[s.name]):r="array"===s.type?[]:{})):_.isUndefined(e["default"])?"string"===o?r="date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string":"integer"===o?r=0:"number"===o?r=0:"boolean"===o?r=!0:"object"===o?(r={},_.forEach(e.properties,function(e,s){var o=_.cloneDeep(e);o["default"]=n(e),r[s]=schemaToJSON(o,i,t,n)})):"array"===o&&(r=[],_.isArray(e.items)?_.forEach(e.items,function(e){r.push(schemaToJSON(e,i,t,n))}):_.isPlainObject(e.items)?r.push(schemaToJSON(e.items,i,t,n)):_.isUndefined(e.items)?r.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process")):r=e["default"]),r};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=JSON.parse(this.definition.example))):this.definition.example=this.examples,schemaToJSON(this.definition,this.models,e,this.modelPropertyMacro)},Model.prototype.getMockSignature=function(){return schemaToHTML(this.name,this.definition,this.models,this.modelPropertyMacro)};


},{"../helpers":4,"lodash-compat/array/indexOf":19,"lodash-compat/collection/forEach":23,"lodash-compat/collection/map":24,"lodash-compat/lang/cloneDeep":103,"lodash-compat/lang/isArray":105,"lodash-compat/lang/isPlainObject":109,"lodash-compat/lang/isString":110,"lodash-compat/lang/isUndefined":112,"lodash-compat/object/keys":113}],9:[function(require,module,exports){
"use strict";var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Operation=module.exports=function(e,t,r,n,s,a,i,o,p){var l=[];if(e=e||{},a=a||{},this.authorizations=a.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=a.consumes||e.consumes||["application/json"],this.produces=a.produces||e.produces||["application/json"],this.deprecated=a.deprecated,this.description=a.description,this.host=e.host||"localhost",this.method=n||l.push("Operation "+r+" is missing method."),this.models=o||{},this.nickname=r||l.push("Operations must have a nickname."),this.operation=a,this.operations={},this.parameters=null!==a?a.parameters||[]:{},this.parent=e,this.path=s||l.push("Operation "+this.nickname+" is missing path."),this.responses=a.responses||{},this.scheme=t||e.scheme||"http",this.schemes=e.schemes,this.security=a.security,this.summary=a.summary||"",this.type=null,this.useJQuery=e.useJQuery,this.parameterMacro=e.parameterMacro||function(e){return e["default"]},this.inlineModels=[],"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,h;if(i){var d;for(d in i)h=new Model(d,i[d],this.models,e.modelPropertyMacro),h&&(this.models[d]=h)}for(u=0;u<this.parameters.length;u++){var c=this.parameters[u];c["default"]=this.parameterMacro(c),"array"===c.type&&(c.isList=!0,c.allowMultiple=!0);var m=this.getType(c);if(m&&"boolean"===m.toString().toLowerCase()&&(c.allowableValues={},c.isList=!0,c["enum"]=["true","false"]),"undefined"!=typeof c["enum"]){var f;for(c.allowableValues={},c.allowableValues.values=[],c.allowableValues.descriptiveValues=[],f=0;f<c["enum"].length;f++){var y=c["enum"][f],g=y===c["default"]?!0:!1;c.allowableValues.values.push(y),c.allowableValues.descriptiveValues.push({value:y,isDefault:g})}}"array"===c.type&&(m=[m],"undefined"==typeof c.allowableValues&&(delete c.isList,delete c.allowMultiple)),c.signature=this.getModelSignature(m,this.models).toString(),c.sampleJSON=this.getModelSampleJSON(m,this.models),c.responseClassSignature=c.signature}var v,b,O=this.responses;if(O[200]?(b=O[200],v="200"):O[201]?(b=O[201],v="201"):O[202]?(b=O[202],v="202"):O[203]?(b=O[203],v="203"):O[204]?(b=O[204],v="204"):O[205]?(b=O[205],v="205"):O[206]?(b=O[206],v="206"):O["default"]&&(b=O["default"],v="default"),b&&b.schema){var M,P=this.resolveModel(b.schema,i);delete O[v],P?(this.successResponse={},M=this.successResponse[v]=P):b.schema.type&&"object"!==b.schema.type&&"array"!==b.schema.type?(this.successResponse={},M=this.successResponse[v]=b.schema):(this.successResponse={},M=this.successResponse[v]=new Model(void 0,b.schema||{},this.models,e.modelPropertyMacro)),M&&(b.description&&(M.description=b.description),b.examples&&(M.examples=b.examples),b.headers&&(M.headers=b.headers)),this.type=b}return l.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(l),this};Operation.prototype.getType=function(e){var t,r=e.type,n=e.format,s=!1;"integer"===r&&"int32"===n?t="integer":"integer"===r&&"int64"===n?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===n?"date-time":"date"===n?"date":"string":"number"===r&&"float"===n?t="float":"number"===r&&"double"===n?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r&&(s=!0,e.items&&(t=this.getType(e.items))),e.$ref&&(t=helpers.simpleRef(e.$ref));var a=e.schema;if(a){var i=a.$ref;return i?(i=helpers.simpleRef(i),s?[i]:i):"object"===a.type?this.addInlineModel(a):this.getType(a)}return s?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10),r=this.inlineModels[t];return r}return null},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var n=this.parameters[r],s=n.signature;t+="\n  * "+n.name+" ("+s+"): "+n.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,n;return e instanceof Array&&(n=!0,e=e[0]),"undefined"==typeof e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):r=!0,r?n?"Array["+e+"]":e.toString():n?"Array["+e.getMockSignature()+"]":e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var n=this.parameters[r];if("undefined"!=typeof e[n.name]&&"header"===n["in"]){var s=e[n.name];Array.isArray(s)&&(s=s.toString()),t[n.name]=s}}return t},Operation.prototype.urlify=function(e){for(var t={},r=this.path,n="",s=0;s<this.parameters.length;s++){var a=this.parameters[s];if("undefined"!=typeof e[a.name])if("path"===a["in"]){var i=new RegExp("{"+a.name+"}","gi"),o=e[a.name];o=Array.isArray(o)?this.encodePathCollection(a.collectionFormat,a.name,o):this.encodePathParam(o),r=r.replace(i,o)}else if("query"===a["in"]&&"undefined"!=typeof e[a.name])if(n+=""===n?"?":"&","undefined"!=typeof a.collectionFormat){var p=e[a.name];n+=Array.isArray(p)?this.encodeQueryCollection(a.collectionFormat,a.name,p):this.encodeQueryParam(a.name)+"="+this.encodeQueryParam(e[a.name])}else n+=this.encodeQueryParam(a.name)+"="+this.encodeQueryParam(e[a.name]);else"formData"===a["in"]&&(t[a.name]=e[a.name])}if(e.queryParams||e.extraQueryParams)for(var l=e.queryParams||e.extraQueryParams,u=Object.keys(l),s=0;s<u.length;s++)void 0!==l[u[s]]&&(n+=""===n?"?":"&",n+=this.encodeQueryParam(u[s])+"="+this.encodeQueryParam(l[u[s]]));var h=this.scheme+"://"+this.host;return"/"!==this.basePath&&(h+=this.basePath),h+r+n},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var n=this.parameters[t];n.required===!0&&"undefined"==typeof e[n.name]&&(r=n.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var n,s,a,i={},o=0;o<this.parameters.length;o++){var p=this.parameters[o];"undefined"!=typeof t[p.name]&&("body"===p["in"]?n=t[p.name]:"formData"===p["in"]&&(i[p.name]=t[p.name]))}if("application/x-www-form-urlencoded"===e["Content-Type"]){var l="";for(s in i)a=i[s],"undefined"!=typeof a&&(""!==l&&(l+="&"),l+=encodeURIComponent(s)+"="+encodeURIComponent(a));n=l}else if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&r.useJQuery){var u=new FormData;u.type="formData";for(s in i)a=t[s],"undefined"!=typeof a&&("file"===a.type&&a.value?(delete e["Content-Type"],u.append(s,a.value)):u.append(s,a));n=u}return n},Operation.prototype.getModelSampleJSON=function(e,t){var r,n,s;if(t=t||{},r=e instanceof Array,s=r?e[0]:e,t[s]?n=t[s].createJSONSample():this.getInlineModel(s)&&(n=this.getInlineModel(s).createJSONSample()),n){if(n=r?[n]:n,"string"==typeof n)return n;if("object"==typeof n){var a=n;if(n instanceof Array&&n.length>0&&(a=n[0]),a.nodeName){var i=(new XMLSerializer).serializeToString(a);return this.formatXml(i)}return JSON.stringify(n,null,2)}return n}},Operation.prototype["do"]=function(e,t,r,n,s){return this.execute(e,t,r,n,s)},Operation.prototype.execute=function(e,t,r,n,s){var a,i,o=e||{},p={};"object"==typeof t&&(p=t,a=r,i=n),"function"==typeof t&&(a=t,i=r),a=a||this.parent.defaultSuccessCallback||helpers.log,i=i||this.parent.defaultErrorCallback||helpers.log,"undefined"==typeof p.useJQuery&&(p.useJQuery=this.useJQuery);var l=this.getMissingParams(o);if(l.length>0){var u="missing required params: "+l;return void helpers.fail(u)}var h,d=this.getHeaderParams(o),c=this.setContentTypes(o,p),m={};for(h in d)m[h]=d[h];for(h in c)m[h]=c[h];var f=this.getBody(m,o,p),y=this.urlify(o);if(y.indexOf(".{format}")>0&&m){var g=m.Accept||m.accept;g&&g.indexOf("json")>0?y=y.replace(".{format}",".json"):g&&g.indexOf("xml")>0&&(y=y.replace(".{format}",".xml"))}var v={url:y,method:this.method.toUpperCase(),body:f,useJQuery:p.useJQuery,headers:m,on:{response:function(e){return a(e,s)},error:function(e){return i(e,s)}}};return this.clientAuthorizations.apply(v,this.operation.security),p.mock===!0?v:void(new SwaggerHttp).execute(v,p)},Operation.prototype.setContentTypes=function(e,t){var r,n,s=this.parameters,a=e.parameterContentType||this.consumes[0],i=t.responseContentType||this.produces[0],o=[],p=[],l={};for(n=0;n<s.length;n++){var u=s[n];if("formData"===u["in"])"file"===u.type?o.push(u):p.push(u);else if("header"===u["in"]&&t){var h=u.name,d=t[u.name];"undefined"!=typeof t[u.name]&&(l[h]=d)}else"body"===u["in"]&&"undefined"!=typeof e[u.name]&&(r=e[u.name])}return!r||"post"!==this.method&&"put"!==this.method&&"patch"!==this.method&&"delete"!==this.method?p.length>0?a=t.requestContentType?t.requestContentType:o.length>0?"multipart/form-data":"application/x-www-form-urlencoded":"DELETE"===this.type?r="{}":"DELETE"!==this.type&&(a=null):t.requestContentType&&(a=t.requestContentType),a&&this.consumes&&-1===this.consumes.indexOf(a)&&helpers.log("server doesn't consume "+a+", try "+JSON.stringify(this.consumes)),i&&this.produces&&-1===this.produces.indexOf(i)&&helpers.log("server can't produce "+i),(a&&""!==r||"application/x-www-form-urlencoded"===a)&&(l["Content-Type"]=a),i&&(l.Accept=i),l},Operation.prototype.asCurl=function(e){var t=this.execute(e,{mock:!0});this.clientAuthorizations.apply(t);var r=[];if(r.push("-X "+this.method.toUpperCase()),t.headers){var n;for(n in t.headers)r.push('--header "'+n+": "+t.headers[n]+'"')}if(t.body){var s;s="object"==typeof t.body?JSON.stringify(t.body):t.body,r.push('-d "'+s.replace(/"/g,'\\"')+'"')}return"curl "+r.join(" ")+' "'+t.url+'"'},Operation.prototype.encodePathCollection=function(e,t,r){var n,s="",a="";for(a="ssv"===e?"%20":"tsv"===e?"\\t":"pipes"===e?"|":",",n=0;n<r.length;n++)0===n?s=this.encodeQueryParam(r[n]):s+=a+this.encodeQueryParam(r[n]);return s},Operation.prototype.encodeQueryCollection=function(e,t,r){var n,s="";if("default"===e||"multi"===e)for(n=0;n<r.length;n++)n>0&&(s+="&"),s+=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[n]);else{var a="";if("csv"===e)a=",";else if("ssv"===e)a="%20";else if("tsv"===e)a="\\t";else if("pipes"===e)a="|";else if("brackets"===e)for(n=0;n<r.length;n++)0!==n&&(s+="&"),s+=this.encodeQueryParam(t)+"[]="+this.encodeQueryParam(r[n]);if(""!==a)for(n=0;n<r.length;n++)0===n?s=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[n]):s+=a+this.encodeQueryParam(r[n])}return s},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)},Operation.prototype.encodePathParam=function(e){var t,r,n,s;if(e=e.toString(),-1===e.indexOf("/"))return encodeURIComponent(e);for(r=e.split("/"),t=[],n=0,s=r.length;s>n;n++)t.push(encodeURIComponent(r[n]));return t.join("/")};
...
},{"../internal/LazyWrapper":28,"../internal/LodashWrapper":29,"../internal/baseLodash":50,"../internal/isObjectLike":90,"../internal/wrapperClone":102,"../lang/isArray":105}],22:[function(require,module,exports){
...
},{"../internal/arrayMap":32,"../internal/baseCallback":34,"../internal/baseMap":51,"../lang/isArray":105}],25:[function(require,module,exports){
...
},{"../lang/isNative":107}],26:[function(require,module,exports){
...
},{"../internal/createWrapper":73,"../internal/replaceHolders":96,"./restParam":27}],27:[function(require,module,exports){
...
},{"../lang/isNative":107,"../object/keys":113,"./baseCopy":36,"./getSymbols":80}],34:[function(require,module,exports){
...
},{"../utility/identity":118,"../utility/property":120,"./baseMatches":52,"./baseMatchesProperty":53,"./bindCallback":61}],35:[function(require,module,exports){
...
},{"../lang/isArray":105,"../lang/isObject":108,"./arrayCopy":30,"./arrayEach":31,"./baseAssign":33,"./baseForOwn":43,"./initCloneArray":82,"./initCloneByTag":83,"./initCloneObject":84,"./isHostObject":85}],36:[function(require,module,exports){
...
},{"../lang/isObject":108}],38:[function(require,module,exports){
...
},{"../object/keysIn":114,"./baseFor":41}],43:[function(require,module,exports){
...
},{"../object/keys":113,"./baseFor":41}],44:[function(require,module,exports){
...
},{"./toObject":100}],45:[function(require,module,exports){
...
},{"../lang/isArray":105,"../lang/isTypedArray":111,"./equalArrays":74,"./equalByTag":75,"./equalObjects":76,"./isHostObject":85}],48:[function(require,module,exports){
...
},{"./baseEach":38,"./getLength":79,"./isLength":89}],52:[function(require,module,exports){
...
},{"../object/keys":113,"../utility/constant":117,"./baseIsMatch":49,"./isStrictComparable":91,"./toObject":100}],53:[function(require,module,exports){
...
},{"../array/last":20,"../lang/isArray":105,"./baseGet":44,"./baseIsEqual":46,"./baseSlice":57,"./isKey":87,"./isStrictComparable":91,"./toObject":100,"./toPath":101}],54:[function(require,module,exports){
...
},{"./toObject":100}],55:[function(require,module,exports){
...
},{"./baseGet":44,"./toPath":101}],56:[function(require,module,exports){
...
},{"../utility/identity":118,"./metaMap":93}],57:[function(require,module,exports){
...
},{"../lang/isNative":107,"../utility/constant":117}],63:[function(require,module,exports){
...
},{"./getLength":79,"./isLength":89,"./toObject":100}],66:[function(require,module,exports){
...
},{"../lang/isObject":108,"./baseCreate":37}],69:[function(require,module,exports){
...
},{"../lang/isArray":105,"./baseCallback":34,"./baseFind":39,"./baseFindIndex":40}],70:[function(require,module,exports){
...
},{"../lang/isArray":105,"./bindCallback":61}],71:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":30,"./composeArgs":63,"./composeArgsRight":64,"./createCtorWrapper":68,"./isLaziable":88,"./reorder":95,"./replaceHolders":96,"./setData":97}],72:[function(require,module,exports){
(function (global){
...
},{"./baseSetData":56,"./createBindWrapper":67,"./createHybridWrapper":71,"./createPartialWrapper":72,"./getData":77,"./mergeData":92,"./setData":97}],74:[function(require,module,exports){
...
},{"../object/keys":113}],77:[function(require,module,exports){
...
},{"../utility/noop":119,"./metaMap":93}],78:[function(require,module,exports){
...
},{"../support":116,"../utility/constant":117,"./baseProperty":54,"./realNames":94}],79:[function(require,module,exports){
...
},{"../lang/isNative":107,"../utility/constant":117,"./toObject":100}],81:[function(require,module,exports){
...
},{"../chain/lodash":21,"./LazyWrapper":28,"./getFuncName":78}],89:[function(require,module,exports){
...
},{"./arrayCopy":30,"./composeArgs":63,"./composeArgsRight":64,"./replaceHolders":96}],93:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":30,"./isIndex":86}],96:[function(require,module,exports){
...
},{"../date/now":25,"./baseSetData":56}],98:[function(require,module,exports){
...
},{"../lang/isArguments":104,"../support":116,"./baseForIn":42,"./isHostObject":85,"./isObjectLike":90}],99:[function(require,module,exports){
...
},{"../lang/isArray":105,"./baseToString":58}],102:[function(require,module,exports){
...
},{"./LazyWrapper":28,"./LodashWrapper":29,"./arrayCopy":30}],103:[function(require,module,exports){
...
},{"../internal/baseClone":35,"../internal/bindCallback":61}],104:[function(require,module,exports){
...
},{"../internal/isLength":89,"../internal/isObjectLike":90,"../support":116}],105:[function(require,module,exports){
...
},{"../internal/baseIsFunction":48,"./isNative":107}],107:[function(require,module,exports){
...
},{"../internal/isLength":89,"../internal/shimKeys":99,"../lang/isNative":107,"../lang/isObject":108,"../support":116}],114:[function(require,module,exports){
...
},{"../internal/arrayEach":31,"../internal/isIndex":86,"../internal/isLength":89,"../lang/isArguments":104,"../lang/isArray":105,"../lang/isFunction":106,"../lang/isObject":108,"../lang/isString":110,"../support":116}],115:[function(require,module,exports){
...
},{"../internal/baseToString":58}],116:[function(require,module,exports){
(function (global){
...
},{"../internal/baseProperty":54,"../internal/basePropertyDeep":55,"../internal/isKey":87}],121:[function(require,module,exports){
